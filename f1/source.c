...
void enc_s01_n01(unsigned char * , unsigned char * , unsigned char * );
 ...
 void Cipher(state_t* state, const uint8_t* RoundKey)
{
 ...
 void enc_s01_n01(unsigned char *plaintext, unsigned char *key, unsigned char *ciphertext)
{
  uint8_t buffer[16];
