...
void aes_main(unsigned char *state, unsigned char *expandedKey,  unsigned char *op);
// Implementation: AES encryption
...
void aes_main(unsigned char *state, unsigned char *Key,unsigned char *op)
{
    int i = 0;
int expandedKeySize = 176;
    ...
    int nbrRounds=10;       enum keySize size = SIZE_16; 
    expandKey(expandedKey, Key, size, expandedKeySize);
