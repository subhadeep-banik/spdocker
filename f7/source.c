...
static inline __m128i aes_128_key_expand(__m128i key, __m128i keygened) {
    keygened = ((__m128i)__builtin_ia32_pshufd ((__v4si)(__m128i)(keygened), (int)((((3) << 6) | ((3) << 4) | ((3) << 2) | (3)))));
    key = _mm_xor_si128(key, ((__m128i)__builtin_ia32_pslldqi128 ((__m128i)(key), (int)(4) * 8)));
    key = _mm_xor_si128(key, ((__m128i)__builtin_ia32_pslldqi128 ((__m128i)(key), (int)(4) * 8)));
    key = _mm_xor_si128(key, ((__m128i)__builtin_ia32_pslldqi128 ((__m128i)(key), (int)(4) * 8)));
...
void aes128_load_keys(const uint8_t *enc_key, __m128i *round_keys) {
    ...
    round_keys[1] = aes_128_key_expand(round_keys[0], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[0]), (int)(0x01))));
    round_keys[2] = aes_128_key_expand(round_keys[1], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[1]), (int)(0x02))));
    round_keys[3] = aes_128_key_expand(round_keys[2], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[2]), (int)(0x04))));
    round_keys[4] = aes_128_key_expand(round_keys[3], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[3]), (int)(0x08))));
    round_keys[5] = aes_128_key_expand(round_keys[4], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[4]), (int)(0x10))));
    round_keys[6] = aes_128_key_expand(round_keys[5], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[5]), (int)(0x20))));
    round_keys[7] = aes_128_key_expand(round_keys[6], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[6]), (int)(0x40))));
    round_keys[8] = aes_128_key_expand(round_keys[7], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[7]), (int)(0x80))));
    round_keys[9] = aes_128_key_expand(round_keys[8], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[8]), (int)(0x1B))));
    round_keys[10] = aes_128_key_expand(round_keys[9], ((__m128i) __builtin_ia32_aeskeygenassist128 ((__v2di)(__m128i)(round_keys[9]), (int)(0x36))));
}
...
void enc_s01_n04(uint8_t * plaintext , uint8_t * key,uint8_t * ciphertext)
